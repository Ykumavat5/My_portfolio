...
const Hero = () => {
  return (
    <section className="bg-gradient-to-br from-slate-900 via-[#111827] to-[#0B0E14] text-white py-24 px-4 text-center shadow-md">
      <div className="max-w-3xl mx-auto">
        ...
        >
          ...
          <span className="text-white font-bold">
            <Typewriter
              words={["Full Stack Developer", "Laravel + MERN Developer"]}
              loop={true}
              cursor
              cursorStyle="|"
              typeSpeed={70}
