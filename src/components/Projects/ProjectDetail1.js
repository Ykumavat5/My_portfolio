    ...
    <section className="min-h-screen py-16 px-6 md:px-10 lg:px-20">
      <div className="max-w-6xl mx-auto bg-gray-50 rounded-3xl p-8 md:p-14 relative">
        ...
        <h1 className="text-4xl md:text-5xl font-bold text-center text-teal-600 mb-4">
          Live Project: Kwick Travels Cab Booking Website
        </h1>

        {/* Live Link */}
        <div className="flex justify-center mb-6">
          <a
            href="https://www.kwicktravels.com/"
            target="_blank"
        ...
        <div className="mb-10">
          ...
          <p className="text-gray-700 leading-relaxed text-base md:text-lg">
            This is a live cab booking platform developed using <strong>Laravel</strong> and deployed on 
            <strong> AWS EC2</strong>. I was responsible for developing the complete website architecture,
            backend logic, database management, and admin panel.
            <br /><br />
            The platform allows customers to book rides by selecting pickup and drop locations using
            <strong> Google Places Autocomplete</strong>. Distance and travel estimation are handled using
            <strong> Google Distance Matrix API</strong>, providing accurate route calculations for bookings.
            <br /><br />
            The admin panel provides complete control over bookings, users, pricing, locations, and
            website management. The Admin UI was designed using <strong>Tailwind CSS</strong> for a
        ...
        <div>
          ...
          <ul className="list-disc list-inside text-gray-700 text-base md:text-lg space-y-3 ml-1">
            ...
            <li className="flex items-start gap-2">
              ...
              Custom admin panel for managing bookings, customers, pricing, and services
            </li>
            ...
            <li className="flex items-start gap-2">
              ...
              Authentication, user management, and admin role permissions
            </li>
